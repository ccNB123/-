...
<form action="${pageContext.request.contextPath}/card/insert" method="post" target="_parent">
   <table align="center">
      <tr>
         <td>等级名称：</td>
         <td><input class="text-box single-line" id="cardlevelsLevelname" name="cardlevelsLevelname" type="text" value="" /></td>
      </tr>
       <tr>
            <td>所需最大积分：</td>
         <td><input class="text-box single-line" id="cardlevelsNeedpoint" name="cardlevelsNeedpoint" type="text" value="" /></td>
       </tr>
       <tr>
            <td>兑换比例：</td>
         <td><input class="text-box single-line" id="cardlevelsPoint" name="cardlevelsPoint" type="text" value="" /></td>
       </tr>
       <tr>
       <td><p style="color: Red;" >(注: 消费xx人民币自动兑换成1积分,默认: 10RMB=1积分)</p></td>
          ...
          <tr>
            <td>折扣比例：</td>
         <td><input class="text-box single-line" id="cardlevelsPercent" name="cardlevelsPercent" type="text" value="" /></td>
       </tr>
       <tr>
