...
<form action="${pageContext.request.contextPath}/user/update" method="post" target="_parent">
   ...
   <table align="center">
      <tr>
       ...
       <tr>
        ...
        <tr>
            <td>是否可以删除：</td>
         <td><input class="text-box single-line" id="usersIsdel" name="usersIsdel" type="checkbox" value="1" <c:if test="${user.usersIsdel eq 1 }">checked</c:if> />是</td>
       </tr>
       <tr>
           <td></td>
