...
<link href="${pageContext.request.contextPath}/easyui/default/themes/easyui.css" rel="stylesheet" type="text/css" />
...
<body>
	<script type="text/javascript">
		function aa() {
			...
			if ($("#memcardsCardid").val() == "") {
				$.messager.alert("提示", "请输入卡号", "warning");
				return false;
			}
	...
	<form action="${pageContext.request.contextPath}/mem/insert" method="post" target="_parent">
		<fieldset title="会员基本信息">
			<table align="center"> 
				<tr>
					<td>会员卡号：</td>
					<td><input class="text-box single-line" id="memcardsCardid" name="memcardsCardid" type="text" value="" /></td>
					<td></td>
					<td></td>
				</tr>
				<tr>
					<td>会员姓名：</td>
					<td><input class="text-box single-line" id=memcardsName name="memcardsName" type="text" value="" /></td>
					<td>手机号码：</td>
					<td><input class="text-box single-line" id="memcardsMobile" name="memcardsMobile" type="text" value="" /></td>
				</tr>
				<tr>
					<td>卡片密码：</td>
				...
				<tr>
					...
					<td><input checked="True" data-val="true"
						...
						id="memcardsBirthdaytype" name="memcardsBirthdaytype" type="radio" value="0" /> 公历 
						<input checked="checked" id="memcardsBirthdaytype" name="memcardsBirthdaytype" type="radio" value="1" /> 农历</td>
					<td><input class="text-box single-line" data-val="true"
						...
						id="memcardsBirthdayMonth" name="memcardsBirthdayMonth" type="text" value="" /> 月</td>
					<td><input class="text-box single-line" data-val="true"
						data-val-number="字段 memcardsBirthdayDay 必须是一个数字。"
						data-val-required="memcardsBirthdayDay 字段是必需的。" id="memcardsBirthdayDay" name="memcardsBirthdayDay" type="text" value="" /> 日</td>
				</tr>
				<tr>
					...
					<input class="Wdate text-box single-line" data-val="true"
						...
						name="memcardsPasttime" type="datetime" value="<fmt:formatDate value="${user.birthday }" pattern="yyyy-MM-dd"/>" readonly="readonly" onclick="WdatePicker();"/>
					</td>
					<td></td>
				</tr>
				<tr>
					...
					<td><input class="text-box single-line" data-val="true"
						...
						data-val-required="memcardsMoney 字段是必需的。" id="memcardsMoney" name="memcardsMoney" type="text" value="" />
					</td>
				</tr>
				<tr>
					<td colspan="2"><hr /></td>
				...
				<tr>
					<td>积分数量：</td>
					<td><input class="text-box single-line" id="memcardsPoint" name="memcardsPoint" type="text" value="" /></td>
					<td><input checked="checked" data-val="true"
				...
				<tr>
					...
					<td><input class="text-box single-line" data-val="true"
						...
						id="memcardsReferercard" name="memcardsReferercard" type="text" placeholder="请输入推荐人的会员卡号" value="" />
						<input type="button" onclick="screch()" value="查找" /></td>
					<td>推荐人姓名：</td>
					<td><input class="text-box single-line" id="memcardsReferername" name="memcardsReferername" type="text" value="" /></td>
				</tr>
				<tr>
					<td></td>
					<td><!-- <input data-val="true" data-val-number="字段 memcardsId 必须是一个数字。" data-val-required="memcardsId 字段是必需的。"
						id="memcardsId" name="memcardsId" type="hidden" value="" /> -->
						...
						<input type="button" id="sum" value="添加" />
					</td>
					<td></td>
					<td></td>
				</tr>
