...
<form action="${pageContext.request.contextPath}/shop/insert" method="post" target="_parent">
   <table align="center">
      <tr>
         <td>店铺名称：</td>
         <td><input class="text-box single-line" id="shopName" name="shopName" type="text" value="" /></td>
      </tr>
       <tr>
         <td>店铺类型：</td>
         <td>
       ...
       <tr>
            <td>联系人：</td>
         <td><input class="text-box single-line" id="shopContactname" name="shopContactname" type="text" value="" /></td>
       </tr>
       <tr>
            <td>联系电话：</td>
         <td><input class="text-box single-line" id="shopContacttel" name="shopContacttel" type="text" value="" /></td>
       </tr>
          <tr>
            <td>店铺地址：</td>
         <td><input class="text-box single-line" id="shopAddress" name="shopAddress" type="text" value="" /></td>
       </tr>
        <tr>
            <td>备注：</td>
         <td><input class="text-box single-line" id="shopRemark" name="shopRemark" type="text" value="" /></td>
       </tr>
       <tr>
           <td></td>
