...
<form action="${pageContext.request.contextPath}/user/insert" method="post" target="_parent">
   <table align="center">
      <tr>
         <td>登录名：</td>
         <td><input class="text-box single-line" id="usersLoginname" name="usersLoginname" type="text" value="" /></td>
      </tr>
       <tr>
         <td>真实姓名：</td>
         <td><input class="text-box single-line" id="usersRealname" name="usersRealname" type="text" value="" /></td>
       </tr>
       <tr>
            <td>性别：</td>
         <td><input class="text-box single-line"  name="usersSex"  value="男" type="radio" checked="checked" />男</td>
         <td><input class="text-box single-line"  name="usersSex"  value="女" type="radio" />女</td>
       </tr>
       <tr>
            <td>联系电话：</td>
         <td><input class="text-box single-line" id="usersTelephone" name="usersTelephone" type="text" value="" /></td>
       </tr>
          <tr>
            <td>角色：</td>
         <td>
        ...
        <tr>
            <td>是否可以删除：</td>
         <td><input class="text-box single-line" id="usersIsdel" name="usersIsdel" type="checkbox" value="1" />是</td>
       </tr>
       <tr>
           <td></td>
