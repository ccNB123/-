...
<form action="${pageContext.request.contextPath}/gift/insert" method="post" target="_parent" enctype="multipart/form-data">
   <table align="center">
      <tr>
         <td>礼品代号：</td>
         <td><input class="text-box single-line" id="exchanggiftsGiftcode" name="exchanggiftsGiftcode" type="text" value="" /></td>
      </tr>
       <tr>
            <td>礼品名称：</td>
         <td><input class="text-box single-line" id="exchanggiftsGiftname" name="exchanggiftsGiftname" type="text" value="" /></td>
       </tr>
       <tr>
            <td>图片：</td>
       ...
       <tr>
            <td>所需积分：</td>
         <td><input class="text-box single-line" id="exchanggiftsPoint" name="exchanggiftsPoint" type="text" value="" /></td>
       </tr>
       <tr>
            <td>礼品数量：</td>
         <td><input class="text-box single-line" id="exchanggiftsInteger" name="exchanggiftsInteger" type="text" value="" /></td>
       </tr>
       <tr>
            <td>备注：</td>
         <td><input class="text-box single-line" id="exchanggiftsRemark" name="exchanggiftsRemark" type="text" value="" /></td>
       </tr>
       <tr>
           <td></td>
